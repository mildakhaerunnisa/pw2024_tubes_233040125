...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark mx-auto">
        <div class="container">
            <a href="admin.php" class="fw-bold fst-italic align-middle navbar-brand">Feelmovie</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <a href="admin.php" class="nav-item nav-link page-scroll">
    ...
    <section id="admin" class="my-5 container justify-content-center">
        <h1 class="text-center display-8 fw-bold mb-3">Feelmovie</h1>

        <!-- Action Bar -->
        <form action="" method="POST" class="mb-3">
            <!-- Searching -->
            <input type="text" name="keyword_category" id="keyword_category" size="30" placeholder="Search" autocomplete="off" autofocus>
            <button type="submit" name="cari" id="tombol-cari_category" class="btn btn-secondary">Search</button>
            <!-- add -->
            <a href="tambahKategori.php" class="btn btn-primary float-sm-end"><i class="bi bi-plus-circle"></i> Add Catategory</a>
        </form>
